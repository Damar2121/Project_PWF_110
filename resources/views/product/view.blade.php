                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 tracking-tight">Product Details</h1>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <x-delete-button :url="route('product.delete', $product->id)" name="Delete" confirm="Are you sure you want to delete this product?" />
                        </div>
                    </div>
                    ...
                    <div class="rounded-xl border border-gray-200 dark:border-gray-700 divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        <div class="flex items-center px-5 py-4">
                            ...
                            <div class="text-sm font-mono font-medium text-gray-900 dark:text-gray-100">Rp {{ number_format($product->price, 0, ',', '.') }}</div>
                        </div>
